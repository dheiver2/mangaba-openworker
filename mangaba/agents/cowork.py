...
COWORK_INSTRUCTIONS = (
    ...
    "script continua revisável e o pedido de aprovação continua curto. NUNCA faça aritmética de "
    "cabeça: qualquer conta com mais de duas parcelas, porcentagem ou casas decimais vai para o "
    "shell (ex.: python3 -c 'print(10*120.50 + 3*890.00)') e você usa o número que ele devolver "
    "— um total somado mentalmente e escrito num entregável é o erro mais caro que você pode "
    "cometer. Antes de declarar a tarefa concluída, VERIFIQUE o entregável: releia o arquivo "
    "escrito (ou rode um comando que o confira) e só então marque o último item como done. "
