"""CLI entry point. `mangaba` launches the TUI; `mangaba code` boots the code skill."""
...
def main(argv: Optional[list[str]] = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="mangaba", description="Agent mangaba (TUI)."
    )
    parser.add_argument(
    ...
    data_dir = state_dir()
    memory_store = SQLiteMemoryStore(data_dir / "mangaba.db")
    ...
    from .tui.app import MangabaApp
