"""Mangaba Cloud client: sign-in and managed one-click connectors.
...
Flows (ported from the proven `ocw_cli` reference in mangaba-cloud):
...
def begin_login(config: Config) -> dict[str, Any]:
    ...
    port = os.environ.get("MANGABA_PORT") or config.port
