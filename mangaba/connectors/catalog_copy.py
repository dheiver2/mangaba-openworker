...
the Mangaba Cloud app requests. Overclaiming here is a product bug.
...
ABOUT: dict[str, str] = {
    "telegram": "Chat with your mangaba from Telegram. Messages to your bot "
    "reach the agent and replies come back to the same chat — only senders on "
    "your allow-list get through.",
    "slack": "Bring your mangaba into Slack: mention it in a channel or DM it, "
    ...
    "status. One click installs the Mangaba GitHub App on the repositories "
