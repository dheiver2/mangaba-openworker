...
from mangaba.connectors.tool_defs import mcp_pinned_tools, mcp_tool_defs, tool_dicts
from mangaba.mcp.config import put_global_server, read_global
...
def test_stale_token_reauth_never_opens_a_browser_mid_turn(tmp_path, monkeypatch):
    ...
    from mangaba.mcp import oauth as mcp_oauth
