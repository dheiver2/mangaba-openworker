...
from mangaba.personas.manifest import ManifestError, parse_manifest
...
---
You are a demo mangaba. Do helpful things.
"""


def test_parse_valid():
    m = parse_manifest(VALID)
    assert m.id == "demo" and m.name == "Demo Mangaba"
    ...
    assert m.system_prompt.startswith("You are a demo mangaba")
