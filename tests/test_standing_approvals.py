...
from mangaba.automation import Schedule, ScheduledTask, Scheduler, TaskRun, TaskStore
from mangaba.automation.models import grant_entries, rule_entry, rule_parts
from mangaba.automation.tools import scheduling_tools
from mangaba.engine import ApprovalOutcome, PermissionRequest
from mangaba.permissions import Mode, PermissionEngine, standing_rule_candidate
...
def test_create_tool_stores_write_grants(tmp_path):
    ...
    props = create.__mangaba_schema__["function"]["parameters"]["properties"]
    ...
    assert (
        "permissions"
        not in update.__mangaba_schema__["function"]["parameters"]["properties"]
    )
...
def test_engine_events_carry_standing_context(tmp_path):
    ...
    send_message.__mangaba_schema__ = {
        "type": "function",
        "function": {
            "name": "send_message",
            "description": "send",
