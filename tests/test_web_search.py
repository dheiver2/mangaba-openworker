...
from mangaba.web import (
    SearchResult,
    build_provider,
    make_web_search_tool,
    provider_names,
)
from mangaba.web.providers import (
    BraveProvider,
    DuckDuckGoProvider,
    TavilyProvider,
    WebSearchProvider,
...
def test_tool_returns_results():
    ...
    assert tool.__mangaba_schema__["function"]["name"] == "web_search"
...
def test_resolve_provider_from_secretstore(tmp_path):
    from mangaba.web import resolve_provider
...
def test_engine_registers_web_search(tmp_path):
    ...
    from mangaba.agents import chat_agent
