...
from mangaba.tools.files import file_tools
from mangaba.tools.git import git_tools
from mangaba.tools.search import _py_grep, search_tools
from mangaba.web.fetch import _html_to_text, make_web_fetch_tool
...
def test_ripgrep_uses_the_same_ignored_dirs_as_the_python_fallback(tmp_path, monkeypatch):
    import mangaba.tools.search as search
...
def test_code_agent_has_grep_and_git_log_not_search_files(tmp_path):
    from mangaba.agents.base import AgentContext
    from mangaba.agents.code import code_agent
...
def test_cowork_has_grep_not_search_files(tmp_path):
    from mangaba.agents.base import AgentContext
    from mangaba.agents.cowork import cowork_tool_factory
