...
from mangaba.connections import (
    PersonaConnectionStore,
    SessionConnectionStore,
    effective,
)
from mangaba.connectors.base import MessageEvent, SessionSource
from mangaba.personas import registry as persona_registry
from mangaba.personas.manifest import load_manifest_file
from mangaba.providers import ModelCapabilities, ProviderClient
...
def _isolate_state_dir(tmp_path, monkeypatch):
    ...
    global state dir (`~/.config/mangaba`) unless `MANGABA_STATE_DIR` is set — so without this a
