...
function VoiceInputSection() {
  ...
  return (
    <section>
      ...
      {!desktop ? (
        <div className={CARD + " p-4 text-[13px] text-muted"}>Voice Input setup is available in the Mangaba desktop app.</div>
      ) : (
...
function PersonasSection({ onOpenPersona }: { onOpenPersona?: (id: string) => void }) {
  ...
  return (
    <section>
      <PanelHead
        title="Personas"
        sub="Which mangabas are enabled and shown in the picker, plus installing new persona bundles."
      />
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          ...
          <span className="block text-[12px] text-muted">
            Curated mangabas from the Mangaba team — see what each can do before installing.
          </span>
        </span>
...
function AppearanceSection() {
  ...
  return (
    <section>
      <PanelHead title="General" sub="How Mangaba looks and behaves on this machine." />
        ...
        <div className={CARD + " p-4"}>
          ...
          <label className="flex items-start gap-3 py-2">
            ...
            <span>
              ...
              <span className="block text-[12px] text-muted">Launch Mangaba automatically when you sign in.</span>
            </span>
          </label>
          <label className="flex items-start gap-3 py-2">
  ...
  return (
    <div className={CARD + " p-4 mb-4"} data-testid="trusted-workspaces-card">
      ...
      <div className={FIELD_HELP}>
        Trusted projects may manage their command allowances in .mangaba/config.toml.
      </div>
      {workspaces === null ? (
        ...
        <span className="text-[12px] text-muted">
          {state === "none"
            ...
            : state === "error"
              ...
              : "Downloading — Mangaba restarts by itself when it's ready."}
        </span>
      )}
    </span>
  );
  ...
  return (
    <div className={CARD + " p-4 mb-4"}>
      ...
      <label className="flex items-center gap-3 mt-2.5">
        <span className="text-[13px] text-ink">Conversations shown per mangaba</span>
        <input
          type="number"
          min={1}
          max={50}
      ...
      <div className={FIELD_HELP}>
        Longer lists collapse behind &ldquo;Show more&rdquo;. Applies per mangaba and per project.
      </div>
    </div>
  );
}
