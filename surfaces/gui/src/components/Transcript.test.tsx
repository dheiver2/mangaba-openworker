...
const TURN: Item[] = [
  ...
  { kind: "assistant", text: "Posted to #all-mangaba." },
];
...
describe("TurnGroup (Transcript §33)", () => {
  it("groups the whole turn; answer stays outside; narration and humanized steps inside", () => {
    ...
    expect(screen.getByText("Posted to #all-mangaba.")).toBeTruthy();
...
describe("bubble hover affordances (FB-005)", () => {
  ...
  const ITEMS: Item[] = [
    ...
    { kind: "assistant", text: "Done — posted to #all-mangaba." }, // pre-stamp history: no ts
  ];
