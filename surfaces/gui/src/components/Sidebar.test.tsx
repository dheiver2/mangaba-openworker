...
const PERSONAS = {
  personas: [
    { id: "cowork", name: "Mangaba", icon: "cowork", tagline: "general assistant", family: "knowledge", enabled: true, surfaced: true, default: true },
...
describe("Sidebar group/filter control", () => {
  it("choosing Persona persists via setNavLayout and switches to the per-persona accordion", async () => {
    ...
    // the accordion — otherwise "Ops" also matches the filter-by-mangaba checkbox.
    fireEvent.click(control);
