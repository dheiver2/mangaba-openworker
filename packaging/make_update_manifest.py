...
uploads):
    ...
    Mangaba-macos-arm64.app.tar.gz(.sig)   -> platforms["darwin-aarch64"]
    Mangaba-windows-setup.exe(.sig)        -> platforms["windows-x86_64"]
...
ARTIFACTS = {
    "Mangaba-macos-arm64.app.tar.gz": "darwin-aarch64",
    "Mangaba-windows-setup.exe": "windows-x86_64",
}
