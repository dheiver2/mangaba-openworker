...
echo ""
echo "AVISO: build não assinado. As checagens acima cobrem o ARTEFATO; o FUNCIONAMENTO"
echo "em Windows real é validado pelo workflow smoke-windows a cada release publicada"
echo "(instala, abre, sidecar de pé, /v1/health e frontend<->backend — não cobre a UI"
echo "visualmente). Na primeira execução o SmartScreen pede 'Mais informações' >"
echo "'Executar assim mesmo' — assinatura de código resolveria isso."
